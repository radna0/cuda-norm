...
#
# Usage:
#   HF_TOKEN=... ./upload_folder_to_hf_dataset_repo.sh <repo_id> <local_dir> [--private]
#
# Example:
...
REPO_ID="${1:?usage: $0 <repo_id> <local_dir> [--private]}"
LOCAL_DIR="${2:?usage: $0 <repo_id> <local_dir> [--private]}"
PRIVATE_FLAG="${3:-}"
